...
function validacionLogin() {
   ...
   const mensajeErrorCorreo = document.getElementById(
      "mensaje-error-correo-login"
   );
...
function validacionSignup() {
   ...
   const mensajeErrorNombre = document.getElementById(
      "mensaje-error-nombre-signup"
   );
...
function comprobarTelefono() {
   ...
   const mensajeErrorTelefono = document.getElementById(
      "mensaje-error-telefono"
   );
...
function comprobarNombreSignUp() {
   ...
   const mensajeErrorApellidos = document.getElementById(
      "mensaje-error-apellidos-signup"
   );
...
document
   .querySelector(".popup-login .close-bttn")
...
document
   .querySelector(".popup-signup .close-bttn")
   .addEventListener("click", function () {
